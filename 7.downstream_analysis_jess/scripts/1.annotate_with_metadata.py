...
def annotate_with_platemap(profile_path: str, platemap_path: str, platemap_sep: str, batch_name: str, output_file_path: Optional[str] = None):
    """
    ...
    platemap = pl.scan_csv(platemap_path, separator = platemap_sep).filter(pl.col("plate_map_name").str.contains(batch_name))
...
def main():
    ...
    for batch_name in batches:
        ...
        for file in tqdm(all_paths):
            ...
            df_ann = annotate_with_platemap(orig_file, platemap_file, "\t", batch_name)
