...
def main():
    ...
    control_group_runner(
        ...
        feat_cols_dna, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='dna_REF')
    print("Finish REF-REF with dna features")
    ...
    control_group_runner(
        ...
        feat_cols_dna, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='dna_VAR')
    print("Finish VAR-VAR with dna features")
    ...
    experimental_group_runner(
        ...
        ref_group = ref_well_group,
        data_dir = result_dir, 
        feat_col = feat_cols_dna, 
        batch_name = 'Rep_Ctrls_scen4',
        protein_prefix = 'dna')
    print("Finish WT-VAR with dna features")
    ...
    null_group_runner(
        ...
        feat_cols_dna, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='dna_NULL')
    print("Finish NULL with dna features")      
    ...
    control_group_runner(
        ...
        feat_cols_agp, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='agp_REF')
    print("Finish REF-REF with agp features")
    ...
    control_group_runner(
        ...
        feat_cols_agp, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='agp_VAR')
    print("Finish VAR-VAR with agp features")
    ...
    experimental_group_runner(
        ...
        ref_group = ref_well_group,
        data_dir = result_dir, 
        feat_col = feat_cols_agp, 
        batch_name = 'Rep_Ctrls_scen4',
        protein_prefix = 'agp')
    print("Finish WT-VAR with agp features")
    ...
    null_group_runner(
        ...
        feat_cols_agp, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='agp_NULL')
    print("Finish NULL with agp features") 
    ...
    control_group_runner(
        ...
        feat_cols_mito, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='mito_REF')
    print("Finish REF-REF with mito features")
    ...
    control_group_runner(
        ...
        feat_cols_mito, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='mito_VAR')
    print("Finish VAR-VAR with mito features")
    ...
    experimental_group_runner(
        ...
        ref_group = ref_well_group,
        data_dir = result_dir, 
        feat_col = feat_cols_mito, 
        batch_name = 'Rep_Ctrls_scen4',
        protein_prefix = 'mito')
    print("Finish WT-VAR with mito features")
    ...
    null_group_runner(
        ...
        feat_cols_mito, 
        batch_name='Rep_Ctrls_scen4',
        protein_prefix='mito_NULL')
    print("Finish NULL with mito features")   
